  ...
  <el-card class="box-card">
    ...
    <el-form ref="ruleForm" :model="form" :rules="rules" label-width="100px">
      ...
      <el-form-item label="图层颜色">
        <el-color-picker v-model="form.styleColor" show-alpha></el-color-picker>
      </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        auth: [{ required: true, message: "图层权限", trigger: "change" }]
      }
    };
  },
  watch: {
  ...
  methods: {
    ...
    onSubmit(formName) {
      ...
      if (this.form.measureNums.length !== this.form.protocolNums.length) {
    ...
    saveDrawLayerGson() {
      ...
      // 遍历完相交的要素
      getProtocolNumsByMeasureNums({ measureNums: this.form.measureNums }).then(
        r => {
