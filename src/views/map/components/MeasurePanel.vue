            ...
            startMeasure(LenthOrArea) {
                ...
                measureDraw.on('drawstart', function (evt) {
                    ...
                    const startPointOverlay = new Overlay({
                        ...
                        className:
                            'ol-tooltip-measure ol-tooltip .ol-tooltip-static',
                        position: [0, 0],
                    });
                    ...
                    sketchFeaChangeListener = sketchFea
                        ...
                        .on('change', function (e) {
                            ...
                            if (coordinates.length > coordinates_length) {
                                ...
                                partDistanceOverlay.element.style.display =
                                    'block';
                ...
                measureDraw.on('drawend', (evt) => {
                    ...
                    this.type === 'LineString' &&
                        evt.feature.getGeometry().getCoordinates().length ===
                            2 &&
                        olmap
                            .getOverlays()
                            .getArray()
                            .filter(
                                (i) =>
                                    i.options.name == 'totalAreaDistanceOverlay'
                            )
                ...
                drawLfeas.forEach((drawLfea) => {
                    ...
                    buidingLfeas.forEach((buidingLfea) => {
                        ...
                        if (bool) {
                            ...
                            !measureNums.includes(measureNum) &&
                                measureNums.push(measureNum);
                        }
                    });
                });
                return measureNums;
