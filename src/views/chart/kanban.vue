<template>
  <div class="kanbanvue">
    ...
    ></i>
    <i title="退出数据大屏" class="el-icon-switch-button box-toggler" style="right: 0px; top: 10px" @click="$router.go(-1)"/>
      ...
      <div class="date">
        ...
        <el-dropdown :hide-on-click="false">
          <el-link :underline="false">
            <i class="el-icon-setting" style="color: white" title="设置"></i>
          </el-link>
          <el-dropdown-menu slot="dropdown">
            <el-dropdown-item>
              <el-checkbox v-model="isPureBg">纯图片背景</el-checkbox>
            </el-dropdown-item>
          </el-dropdown-menu>
        </el-dropdown>
      </div>
        ...
        series: [
          {
            ...
            areaStyle: {
              color: {
                ...
                y: 1,
                colorStops: [
                  { offset: 0, color: "rgba(61,97,245,0)" },
                  { offset: 1, color: "rgba(61,97,245,.5)" },
                ],
              },
            },
          },
